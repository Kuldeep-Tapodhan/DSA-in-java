...
//        System.out.println(str.substring(0,4));
        ...
        // interning means when the value of strings are
        // same,rather than creating a new memory it will
        // point to the esisiting memory address..


        // == will check the adrees contet while equals()
        // method will check for the actual content
